...
CHECK $? "downloading cart service from s3 bucket.."
...
CHECK $? "unzipping cart service in app directory.."

npm install &>>$LOGFILE

CHECK $? "installing dependencies for cart service in app directory.."

cp /home/centos/automationscripts/cart.service /etc/systemd/system/cart.service &>>$LOGFILE

CHECK $? "adding cart service to daemon service"
